...
export async function seedCphubContent(): Promise<void> {
  ...
  await db.insert(cphubPagesTable).values([
    ...
    },
    {
      slug: "about",
      title: "About",
      subtitle: "Senior platform engineers. No bench. No project managers.",
      sections: [
        {
          type: "hero",
          eyebrow: "About",
          headline: "Senior platform engineers. No bench. No project managers.",
          sub: "Every engineer on your engagement has production scars. We have designed platforms that handle millions of requests, managed the incidents that woke us up at 3am, and written the runbooks afterwards. That experience is what you get — not a junior handed a spec.",
        },
        {
          type: "stats",
          headline: "By the numbers",
          items: [
            { value: "60+", label: "Production platforms delivered" },
            { value: "14 yr", label: "Average engineering experience" },
            { value: "4 TZs", label: "Follow-the-sun coverage" },
            { value: "99.97%", label: "Avg SLO across active engagements" },
          ],
        },
        {
          type: "values",
          ...
          items: [
            { title: "Pragmatic over perfect", body: "We ship the right thing now and the great thing next quarter. Perfect is the enemy of deployed, and deployed is the only thing that earns trust." },
            { title: "Boring tech, where possible", body: "Postgres, Linux, Terraform, Kubernetes. We reach for battle-tested tools on purpose. Every exciting new tool is a future 3am pager." },
            { title: "Your team, smarter", body: "Every engagement ends with knowledge transfer. We document what we built, pair with your engineers, and leave your team more capable than we found it." },
            { title: "Transparent pricing", body: "Fixed-price options, weekly progress reports, no surprise invoices. You always know what you are paying for and what you are getting." },
            { title: "No offshore handoffs", body: "The engineer you meet in the scoping call is the engineer who writes the code. No project managers in between, no junior substitution after kickoff." },
            { title: "Incidents are systems problems", body: "We do blameless postmortems. A production incident means a system property failed, not a person. We fix systems, not people." },
          ],
        },
        {
          type: "team",
          headline: "The team",
          sub: "Senior engineers who have designed, built and operated cloud platforms across fintech, AI, media, and enterprise SaaS — fully remote, globally distributed.",
          items: [
            {
              name: "Azhar Niaz",
              role: "Co-Founder",
              bio: "Azhar leads strategy and client engagements at Cloud Partner Hub. With a deep background in cloud architecture and DevOps transformation, he has helped engineering teams across multiple industries modernise their delivery pipelines and platform infrastructure.",
              location: "Remote 🌍",
              linkedin: "https://www.linkedin.com/in/azhar8178/",
            },
            {
              name: "Mohammad Umar Siddiqui",
              role: "Senior DevOps Consultant",
              bio: "Umar specialises in CI/CD modernisation, infrastructure-as-code, and cloud migration. He has designed and delivered end-to-end DevOps transformations for companies ranging from early-stage startups to enterprise scale.",
              location: "Remote 🌍",
              linkedin: "https://www.linkedin.com/in/muhammad-umar-siddiqui-3526a0b3/",
            },
            {
              name: "Ghani Uz Zaman",
              role: "Senior DevOps Engineer",
              bio: "Ghani brings deep hands-on expertise in Kubernetes, container orchestration, and cloud-native platform engineering. He is the team's go-to engineer for complex multi-service deployments and reliability challenges.",
              location: "Remote 🌍",
              linkedin: "https://www.linkedin.com/in/ghani-uz-zaman/",
            },
            {
              name: "Muzzammil Farooq Khan",
              role: "AWS Solutions Architect · DevOps & Cloud Engineer",
              bio: "Muzzammil combines deep AWS expertise with practical DevOps engineering. He designs cloud landing zones, cost-optimised architectures, and automated infrastructure pipelines that engineering teams can own and operate independently.",
              location: "Remote 🌍",
        ...
        },
        {
          ...
          sub: "We take on 3-4 new engagements per quarter. Tell us about your stack and we will let you know if we are a good fit.",
          cta: { label: "Start the conversation", href: "/contact" },
        },
      ],
      seoTitle: "About · Cloud Partner Hub",
      seoDescription: "Senior platform engineers building cloud and DevOps platforms for ambitious teams. Meet the Cloud Partner Hub team.",
      status: "published",
      publishedAt: now,
    },
    {
